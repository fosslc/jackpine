...
{
  private static final Logger logger = Logger.getLogger(ReadSpatialConvexHullPolygon.class);
  ...
  public void prepare() throws Exception
  {
	  ...
	  if (dialect.getSqlDialectType() == SpatialSqlDialect.SupportedSqlDialect.Mysql) {
		  logger.error("ReadSpatialConvexHullPolygon not supported for Mysql");
		  return;
	  }
	  else {  
